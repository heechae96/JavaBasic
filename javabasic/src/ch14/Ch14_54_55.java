...
public class Ch14_54_55 {
	...
	public static void main(String[] args) {
		...
		Map<Integer, Map<Integer, Student3>> topStuByHakAndBan = Stream.of(stuArr)
				.collect(groupingBy(Student3::getHak,	// 학년별
						groupingBy(Student3::getBan,	// 반별
						collectingAndThen(
		...
		Map<String, Set<Student3.Level>> stuByScoreGroup = Stream.of(stuArr)
				.collect(groupingBy(s -> s.getHak() + "-" + s.getBan(), // 학년, 반을 통째로 그룹화
					mapping(s -> {
					if (s.getScore() >= 200)
						return Student3.Level.HIGH;
					else if (s.getScore() >= 100)
